pub const CODE: &str = r#"pub use dotenv::{from_path, vars};
use error::Error;
...
pub fn set_defaults() {
    // Cookie settings
    set_if_not_empty("COOKIE_NAME", "RustApp");
    ...
    set_if_not_empty("EMAIL_SEND_VIA", "rust_dev");
    set_if_not_empty("DEFAULT_SENDER_NAME", "RustApp");
